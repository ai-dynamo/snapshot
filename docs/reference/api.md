...
| `compress` | `false` | Enable lossless CRIU per-page LZ4 compression, zero-page omission, and automatic restore decompression concurrency. Compressed images use buffered I/O. |
