...
type mounter interface {
	...
	MountInterposer(ctx context.Context, nsFd *os.File) (mountRef, error)
...
func (m *execMounter) MountInterposer(ctx context.Context, nsFd *os.File) (mountRef, error) {
	return m.mountInNamespace(ctx, nsFd, "mount-interposer-fd", "unmount-interposer-fd")
}
