...
func (Failure_Code) EnumDescriptor() ([]byte, []int) {
	return file_v1_pagebroker_proto_rawDescGZIP(), []int{17, 0}
}
...
type WaitDirectRestoreRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WaitDirectRestoreRequest) Reset() {
	*x = WaitDirectRestoreRequest{}
	mi := &file_v1_pagebroker_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WaitDirectRestoreRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WaitDirectRestoreRequest) ProtoMessage() {}

func (x *WaitDirectRestoreRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_pagebroker_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WaitDirectRestoreRequest.ProtoReflect.Descriptor instead.
func (*WaitDirectRestoreRequest) Descriptor() ([]byte, []int) {
...
type PrepareStagedCheckpointRequest struct {
	...
	IoEngine    *IOEngine              `protobuf:"bytes,2,opt,name=io_engine,json=ioEngine,proto3" json:"io_engine,omitempty"`
	// CRIU dump support from the selected external-memory-provider revision.
	ExternalMemoryProvider *bool `protobuf:"varint,3,opt,name=external_memory_provider,json=externalMemoryProvider,proto3,oneof" json:"external_memory_provider,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *PrepareStagedCheckpointRequest) GetExternalMemoryProvider() bool {
	if x != nil && x.ExternalMemoryProvider != nil {
		return *x.ExternalMemoryProvider
	}
	return false
}
...
func (x *Request) GetWaitDirectRestore() *WaitDirectRestoreRequest {
	if x != nil {
		if x, ok := x.Command.(*Request_WaitDirectRestore); ok {
			return x.WaitDirectRestore
		}
	}
	return nil
}
...
type Request_WaitDirectRestore struct {
	WaitDirectRestore *WaitDirectRestoreRequest `protobuf:"bytes,8,opt,name=wait_direct_restore,json=waitDirectRestore,proto3,oneof"`
}
...
func (*Request_WaitDirectRestore) isRequest_Command() {}
...
func (x *DirectRestoreReady) GetImageDirectory() string {
	if x != nil && x.ImageDirectory != nil {
		return *x.ImageDirectory
	}
	return ""
...
type DirectRestoreStarted struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DirectRestoreStarted) Reset() {
	*x = DirectRestoreStarted{}
	mi := &file_v1_pagebroker_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DirectRestoreStarted) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DirectRestoreStarted) ProtoMessage() {}

func (x *DirectRestoreStarted) ProtoReflect() protoreflect.Message {
	mi := &file_v1_pagebroker_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DirectRestoreStarted.ProtoReflect.Descriptor instead.
func (*DirectRestoreStarted) Descriptor() ([]byte, []int) {
...
func (x *Response) GetDirectRestoreStarted() *DirectRestoreStarted {
	if x != nil {
		if x, ok := x.Result.(*Response_DirectRestoreStarted); ok {
			return x.DirectRestoreStarted
		}
	}
	return nil
}
...
type Response_DirectRestoreStarted struct {
	DirectRestoreStarted *DirectRestoreStarted `protobuf:"bytes,9,opt,name=direct_restore_started,json=directRestoreStarted,proto3,oneof"`
}
...
func (*Response_DirectRestoreStarted) isResponse_Result() {}
...
const file_v1_pagebroker_proto_rawDesc = "" +
	...
	"\x06source\x18\x01 \x01(\v2&.snapshot.pagebroker.v1.StorageBackendR\x06source\x12=\n" +
	"\tio_engine\x18\x02 \x01(\v2 .snapshot.pagebroker.v1.IOEngineR\bioEngine\"\x1a\n" +
	"\x18WaitDirectRestoreRequest\"\x85\x02\n" +
	...
	"\x18external_memory_provider\x18\x03 \x01(\bH\x00R\x16externalMemoryProvider\x88\x01\x01B\x1b\n" +
	"\x19_external_memory_provider\"\x0f\n" +
	"\rCommitRequest\"\x0e\n" +
	"\fAbortRequest\"\x8d\x05\n" +
	"\aRequest\x12\"\n" +
	"\n" +
	...
	"\x0edirect_restore\x18\a \x01(\v2,.snapshot.pagebroker.v1.DirectRestoreRequestH\x00R\rdirectRestore\x12b\n" +
	"\x13wait_direct_restore\x18\b \x01(\v20.snapshot.pagebroker.v1.WaitDirectRestoreRequestH\x00R\x11waitDirectRestoreB\t\n" +
	"\acommandB\r\n" +
	"\v_request_idB\x11\n" +
	...
	"\x10_image_directory\"V\n" +
	"\x12DirectRestoreReady\x12,\n" +
	"\x0fimage_directory\x18\x01 \x01(\tH\x00R\x0eimageDirectory\x88\x01\x01B\x12\n" +
	"\x10_image_directory\"\x16\n" +
	"\x14DirectRestoreStarted\"]\n" +
	...
	"\x14direct_restore_ready\x18\b \x01(\v2*.snapshot.pagebroker.v1.DirectRestoreReadyH\x00R\x12directRestoreReady\x12d\n" +
	"\x16direct_restore_started\x18\t \x01(\v2,.snapshot.pagebroker.v1.DirectRestoreStartedH\x00R\x14directRestoreStartedB\b\n" +
	"\x06resultB\r\n" +
	"\v_request_idB\x11\n" +
...
var file_v1_pagebroker_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_v1_pagebroker_proto_goTypes = []any{
	...
	(*WaitDirectRestoreRequest)(nil),       // 7: snapshot.pagebroker.v1.WaitDirectRestoreRequest
	...
	(*Request)(nil),                        // 11: snapshot.pagebroker.v1.Request
	(*StagedRestoreDirectory)(nil),         // 12: snapshot.pagebroker.v1.StagedRestoreDirectory
	(*DirectRestoreReady)(nil),             // 13: snapshot.pagebroker.v1.DirectRestoreReady
	(*DirectRestoreStarted)(nil),           // 14: snapshot.pagebroker.v1.DirectRestoreStarted
	(*StagedCheckpointDirectory)(nil),      // 15: snapshot.pagebroker.v1.StagedCheckpointDirectory
	(*CommitComplete)(nil),                 // 16: snapshot.pagebroker.v1.CommitComplete
	(*AbortComplete)(nil),                  // 17: snapshot.pagebroker.v1.AbortComplete
	(*Failure)(nil),                        // 18: snapshot.pagebroker.v1.Failure
	(*Response)(nil),                       // 19: snapshot.pagebroker.v1.Response
}
var file_v1_pagebroker_proto_depIdxs = []int32{
	...
	8,  // 9: snapshot.pagebroker.v1.Request.prepare_staged_checkpoint:type_name -> snapshot.pagebroker.v1.PrepareStagedCheckpointRequest
	9,  // 10: snapshot.pagebroker.v1.Request.commit:type_name -> snapshot.pagebroker.v1.CommitRequest
	10, // 11: snapshot.pagebroker.v1.Request.abort:type_name -> snapshot.pagebroker.v1.AbortRequest
	6,  // 12: snapshot.pagebroker.v1.Request.direct_restore:type_name -> snapshot.pagebroker.v1.DirectRestoreRequest
	7,  // 13: snapshot.pagebroker.v1.Request.wait_direct_restore:type_name -> snapshot.pagebroker.v1.WaitDirectRestoreRequest
	0,  // 14: snapshot.pagebroker.v1.Failure.code:type_name -> snapshot.pagebroker.v1.Failure.Code
	12, // 15: snapshot.pagebroker.v1.Response.staged_restore_directory:type_name -> snapshot.pagebroker.v1.StagedRestoreDirectory
	15, // 16: snapshot.pagebroker.v1.Response.staged_checkpoint_directory:type_name -> snapshot.pagebroker.v1.StagedCheckpointDirectory
	16, // 17: snapshot.pagebroker.v1.Response.commit_complete:type_name -> snapshot.pagebroker.v1.CommitComplete
	17, // 18: snapshot.pagebroker.v1.Response.abort_complete:type_name -> snapshot.pagebroker.v1.AbortComplete
	18, // 19: snapshot.pagebroker.v1.Response.failure:type_name -> snapshot.pagebroker.v1.Failure
	13, // 20: snapshot.pagebroker.v1.Response.direct_restore_ready:type_name -> snapshot.pagebroker.v1.DirectRestoreReady
	14, // 21: snapshot.pagebroker.v1.Response.direct_restore_started:type_name -> snapshot.pagebroker.v1.DirectRestoreStarted
...
func file_v1_pagebroker_proto_init() {
	...
	file_v1_pagebroker_proto_msgTypes[18].OneofWrappers = []any{
		...
		(*Response_DirectRestoreStarted)(nil),
	}
	type x struct{}
