...
func main() {
	...
	gpuDevicePaths := flag.String("gpu-device-paths", "{}", "Resolved destination GPU UUID to device path JSON")
	...
	if err := json.Unmarshal([]byte(*gpuDevicePaths), &opts.GPUDevicePaths); err != nil {
