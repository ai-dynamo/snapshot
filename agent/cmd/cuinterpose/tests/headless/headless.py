...
"""Exercise the packaged C frontend and C++ core with headless CUDA fixtures."""
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="cuinterpose-headless-") as directory:
        ...
        for mode in ("queue", "disconnect", "unicast", "multicast", "constructor0", "constructor1", "constructor2"):
    ...
    print("PASS packaged C frontend/C++ unicast/multicast/carrier/fork; no GPU qualification")
