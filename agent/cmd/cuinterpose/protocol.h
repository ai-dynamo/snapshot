...
#define CUINTERPOSER_VERSION 3U
...
enum cuinterposer_operation {
  ...
  CUINTERPOSER_EXPORT_BROKER = 12,
  CUINTERPOSER_RESTORE_BROKERED = 13,
  CUINTERPOSER_RESTORE_BROKERED_COMPLETE = 14,
  CUINTERPOSER_BROKER_GET = 15,
  CUINTERPOSER_BROKER_CLOSE = 16,
  CUINTERPOSER_RESTORE_LOCAL_MULTICAST_MEMBERS = 17,
};
