...
func TestApplyCheckpointStorageMetadata(t *testing.T) {
	...
	ApplyCheckpointStorageMetadata(annotations, snapshotv1alpha1.Storage{
		Type:     StorageTypePVC,
...
func TestResolveCheckpointStorageValidatesBasePath(t *testing.T) {
	t.Run("rejects relative base path", func(t *testing.T) {
		_, err := snapshotv1alpha1.ResolveCheckpointStorage("hash", "", snapshotv1alpha1.Storage{
			Type:     StorageTypePVC,
			BasePath: "checkpoints",
		})
		if err == nil {
	...
	t.Run("normalizes trailing slash", func(t *testing.T) {
		storage, err := snapshotv1alpha1.ResolveCheckpointStorage("hash", "2", snapshotv1alpha1.Storage{
			Type:     StorageTypePVC,
			BasePath: "/checkpoints/",
		})
		if err != nil {
			t.Fatalf("snapshotv1alpha1.ResolveCheckpointStorage() error = %v", err)
		}
	...
	t.Run("allows root base path", func(t *testing.T) {
		storage, err := snapshotv1alpha1.ResolveCheckpointStorage("hash", "", snapshotv1alpha1.Storage{
			Type:     StorageTypePVC,
			BasePath: "/",
		})
		if err != nil {
